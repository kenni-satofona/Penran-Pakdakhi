...
<body>
    ...
    <div class="card card-stats card-warning" style="background: #f1c40f;">
        <div class="card-body">
            <div class="row">
                <div class="col-5">
                ...
                <div class="col-7 d-flex align-items-center tulisan">
                    <div class="numbers">
                        <p class="card-category ket head" style="color: black;">Saldo Idealisman Dakhi</p>
                        <h4 class="card-title ket total" style="color: black;">Rp. <?=$saldoFix;?></h4>
                    </div>
                </div>
            </div>
        </div>
